...
from libs.physics.khrylib.rl.envs.common.mjviewer import MjViewer
from libs.physics.khrylib.mocap.pose import load_amc_file, interpolated_traj
import pickle
import argparse
import glfw
...
version2model = {'1.0': 'humanoid_pd_v2',
                 '2.0': 'humanoid_pd_v4'}
...
expert_meta = {'dt': args.dt, 'mocap_fr': args.mocap_fr, 'scale': args.scale, 'cyclic': args.cyclic,
               'cycle_start': args.cycle_start, 'cycle_end': args.cycle_end, 'select': select,
               'seg_id': args.seg_id, 'select_start': g_offset + select_start, 'select_end': g_offset + select_end}
print(expert_meta)
