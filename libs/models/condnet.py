...
from libs.models.points.point_transformer import pointtransformer_feature_extractor as PointTransformerEnc
import random
...
class CondNet(nn.Module):
    def __init__(self, config):
        ...
        if self.config.pretrained_scene_model != '':
            ...
            print('Load pre-trained scene model weigth \'{}\'..'.format(self.config.pretrained_scene_model))
